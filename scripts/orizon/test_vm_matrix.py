...
def run_ssh_checks(
    ...
    *,
    ...
    commands = [
        ...
        ("desktop hyprctl -j reload", '"parserSummary":{'),
        ("desktop hyprctl -j reload", '"sourceResolve":{'),
        ("desktop hyprctl -j reload", '"runtimeFiles":{'),
        ("desktop hyprctl -j reload", '"settings":{'),
        ("desktop hyprctl -j reload", '"maxDepth":3'),
        ...
        ("desktop hyprctl -j rollinglog", '"sessionPreview":'),
        ("desktop hyprctl -j rollinglog", '"sessionBytesSampled":'),
        ...
        ("desktop app settings", "data-source[0]: /system/desktop-settings.conf kind=path"),
        ...
        ("desktop hyprctl -j app settings", '"dataSources":['),
        ("desktop hyprctl -j app settings", '"source":"/system/desktop-settings.conf"'),
        ("desktop hyprctl -j app settings", '"kind":"path"'),
        ...
        ("pkg info orizon-desktop-hypr", "version 0.102.0"),
        ...
        ("cat /workspace/packages/orizon-desktop-hypr.opkg", "app-data-source-diagnostics"),
        ...
        ("cat /workspace/packages/orizon-desktop-hypr.opkg", "hyprctl-json-rollinglog-session"),
        ...
        ("cat /workspace/packages/orizon-desktop-hypr.opkg", "hyprctl-json-reload-structured"),
