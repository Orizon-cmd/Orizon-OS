...
def run_ssh_checks(
    ...
    *,
    ...
    commands = [
        ...
        ("desktop config doctor", "Hyprland config doctor"),
        ("desktop config apply", "runtime-files:"),
        ...
        ("desktop runtime", "Orizon desktop Hyprland runtime"),
        ...
        ("desktop dispatch exec terminal", "exec terminal client spawned"),
        ("desktop dispatch exec terminal", "exec terminal client spawned"),
        ...
        ("desktop launch terminal", "launched terminal"),
