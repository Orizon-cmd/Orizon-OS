#!/bin/bash
# ============================================================================
# Orizon OS - Create Bootable ISO for VirtualBox/VMware
# ============================================================================
...
OUTPUT_ISO="${BUILD_DIR}/orizon-os.iso"

KERNEL_ELF="${BUILD_DIR}/kernel/orizonos.elf"

echo "============================================"
echo "Orizon OS ISO Creator"
echo "============================================"
...
cp "${KERNEL_ELF}" "${ISO_DIR}/boot/orizon-os.elf"
...
menuentry "Orizon OS" {
    echo "Loading Orizon OS kernel..."
    multiboot2 /boot/orizon-os.elf
    boot
}

menuentry "Orizon OS (Debug Mode)" {
    echo "Loading Orizon OS kernel (debug)..."
    multiboot2 /boot/orizon-os.elf debug verbose
    boot
}

menuentry "Orizon OS (Recovery)" {
    echo "Loading Orizon OS recovery..."
    multiboot2 /boot/orizon-os.elf single recovery
    boot
}
EOF
...
echo "      -nographic -kernel build/kernel/orizonos.elf"
echo ""
