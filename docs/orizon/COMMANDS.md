...
rule-match fields such as `focusHistoryID`, `scope`, `role`, `pinnedAware`,
`summary`, and `safeAction`; it is Hyprland-style diagnostic data, not real
Wayland/wlroots client state.
