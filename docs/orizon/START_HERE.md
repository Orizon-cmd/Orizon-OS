...
- The optional first desktop profile is available through `desktop status`,
  ...
  `desktop hyprctl [-j] `, compact JSON diagnostics/actions for `desktop hyprctl -j clients|workspaces|activeworkspace|activewindow|focushistory|workspacestack|clientmodel|rulematches|layoutstate|layouttree|configerrors|configtrace|getoption|keyword|reload`, `desktop backend`, `desktop protocol`, `desktop autostart`,
