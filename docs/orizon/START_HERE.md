...
- The optional first desktop profile is available through `desktop status`,
  ...
  `desktop version/devices/systeminfo/layouts/layout-tree/animations/decorations/render/configerrors/rollinglog/focus-history`,
  ...
  `desktop hyprctl version/systeminfo/backend/protocol/clients/workspaces/activeworkspace/activewindow/focushistory/layouts/layouttree/animations/decorations/render/descriptions/instances/submap/devices/cursorpos/splash/configerrors/rollinglog/getoption/keyword/binds/layers`, `desktop backend`, `desktop protocol`, `desktop autostart`,
  `desktop windows/clients/activewindow`, active tiling-tree diagnostics, and runtime tiled workspace/client-state commands rather
