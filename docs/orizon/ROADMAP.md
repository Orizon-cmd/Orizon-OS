...
5. Build Intel CNVi Wi-Fi properly: promote the diagnostic MAC/LINK/STA binding
   buffers into guarded firmware queueing, promote the validated Intel `TX_CMD`
   envelope the same way, then install WPA2/WPA3 keys for encrypted traffic.
