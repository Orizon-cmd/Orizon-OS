...
5. Build Intel CNVi Wi-Fi properly: convert the prepared TX DMA management and
   WPA M2 frames into a validated Intel `TX_CMD` path, bind MAC/STA context,
   then install WPA2/WPA3 keys for encrypted traffic.
