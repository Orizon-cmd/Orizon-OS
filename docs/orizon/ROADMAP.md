...
5. Build Intel CNVi Wi-Fi properly: bind MAC/STA context, promote the validated
   Intel `TX_CMD` diagnostic envelope into guarded queueing, then install
   WPA2/WPA3 keys for encrypted traffic.
