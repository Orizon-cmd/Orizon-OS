...
static void ssh_shell_print_desktop(const char *args) {
  ...
  if (*sub == '\0' || ssh_shell_command_is(sub, "status")) {
    ...
    snprintf(out, sizeof(out),
             ...
             "  desktop dispatch movetoworkspace <target>[,<window>] move focused/selected client and follow\r\n"
             "  desktop dispatch movetoworkspacesilent <target>[,<window>] move focused/selected client without switching\r\n"
