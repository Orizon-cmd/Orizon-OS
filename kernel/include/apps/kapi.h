/*
 * Orizon OS Kernel API for Userspace Applications
 * 
 * IMPORTANT: This structure MUST match user/lib/orizon.h exactly!
...
/* Kernel API structure - must match orizon.h layout! */
typedef struct kapi {
    uint32_t version;
