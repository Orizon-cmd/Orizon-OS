...
/* Kernel version */
#define ORIZON_VERSION_MAJOR 0
#define ORIZON_VERSION_MINOR 5
#define ORIZON_VERSION_PATCH 0
...
static void print_banner(void) {
  ...
  printk("\n");
  printk("Orizon OS v%d.%d.%d - ARM64 with GUI\n", ORIZON_VERSION_MAJOR,
         ORIZON_VERSION_MINOR, ORIZON_VERSION_PATCH);
  printk("A Unix-like operating system for ARM64\n");
  printk("Copyright (c) 2026 Orizon OS Project\n");
  printk("\n");
}
...
static void init_subsystems(void *dtb) {
  ...
  ramfs_create_file("todo.txt", 0644,
                    "- Implement Browser\n- Fix Bugs\n- Sleep");
  ramfs_create_file_bytes("sample.mp3", 0644, orizon_seed_mp3, orizon_seed_mp3_len);
