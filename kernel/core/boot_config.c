/*
 * orizon-os - Boot Configuration and Splash Screen
 * 
...
static struct boot_config boot_cfg = {
    ...
    .default_kernel = "/boot/orizon-os.elf",
...
void boot_init(void)
{
    ...
    boot_add_entry("orizon-os", boot_cfg.default_kernel, boot_cfg.kernel_cmdline);
