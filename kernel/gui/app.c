/*
 * Orizon OS - Application Framework
 *
...
static void settings_draw(struct application *app) {
  ...
  y += 30;
  gui_draw_string(270, y, "Orizon OS v0.3.0", 0x808080, 0x1E1E2E);
  y += 20;
...
static void help_draw(struct application *app) {
  ...
  gui_draw_string(base_x + 10, y, "Orizon OS Help", 0x89B4FA, 0x1E1E2E);
  y += 24;
  ...
  gui_draw_string(base_x + 10, y, "Copyright 2026 Orizon OS Project", 0x585B70,
                  0x1E1E2E);
}
