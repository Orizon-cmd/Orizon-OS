...
extern const uint8_t orizon_seed_mp3[];
extern const unsigned int orizon_seed_mp3_len;

extern const uint8_t orizon_seed_jpg[];
extern const unsigned int orizon_seed_jpg_len;
