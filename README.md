...
- premier profil bureau optionnel, inspire de Hyprland, desactive par defaut:
  ...
  `desktop hyprctl -j clients|workspaces|activeworkspace|activewindow|focushistory|workspacestack`, mutation
...
`windows`, `lastwindow`, `focusHistoryID`, `scope`, `role`, `pinnedAware`) et
le marqueur explicite `hyprlandStyleFacade=true`.
