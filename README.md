...
Orizon OS is maintained as its own standalone project and repository.

- GitHub repository: `https://github.com/Orizon-cmd/Orizon-OS.git`
- Local project notes: `docs/orizon/`
...
Orizon OS v2.2.1 - Multi-Architecture OS with Full GUI
```

<p align="center">
  <img src="screenshots/main.png" alt="Orizon OS Desktop" width="800">
</p>

## Overview

Orizon OS is a from-scratch, Unix-like operating system with **full multi-architecture support** for **ARM64** and **x86_64**. It features a custom kernel, a modern macOS-inspired graphical user interface, a full TCP/IP networking stack, and a Virtual File System (VFS). Built with **25,000+ lines** of C and Assembly, it runs natively on QEMU, real hardware (Raspberry Pi 4/5, x86_64 PCs), and Apple Silicon.
...
For a simplified x86_64 build that boots directly from UEFI on real hardware, see the **[orizon-os-x86_64](orizon-os-x86_64/)** folder. It includes:
...
*Orizon OS desktop with animated dock, menu bar, and wallpaper system.*
...
2. Write to USB: `sudo dd if=orizonos-uefi.img of=/dev/sdX bs=4M`
...
- **GitHub**: [github.com/Orizon-cmd](https://github.com/Orizon-cmd)
- **Repository**: [Orizon-cmd/Orizon-OS](https://github.com/Orizon-cmd/Orizon-OS)
- **Issues**: [Report bugs or request features](https://github.com/Orizon-cmd/Orizon-OS/issues)
